...
const TransactionsPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-margin-mobile md:px-margin-desktop py-gutter flex-1 space-y-8">
      ...
      <div className="bg-white dark:bg-surface-container-lowest rounded-xl border border-outline-variant overflow-hidden">
