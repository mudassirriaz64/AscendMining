...
const { rejectDepositSchema } = require('../../validators/admin/deposit.validator');
...
router.post('/:id/reject', auth, requireRole('admin', 'support_agent'), validate(rejectDepositSchema), depositController.rejectDeposit);
